...
static const char *fonts[] = {"Ubuntu-B:size=11", "Material Design Icons-Regular:size=13"};
static const char dmenufont[] = "Ubuntu-B:size=13";
// static const char  tt []            = "32";
// static const char  kk []            = "4";
// static const char  yy []            = "3";
// background color
...
static const char *tags[] = {"󰣇","󰨞","󰈹","󰏆","󰓇","󰡜"}; 
...
// static const char *web [] = { "vieb", NULL };
// static const char *web1[] = {"qutebrowser", NULL};
static const char *yt[] = {"firefox", NULL};
static const char *kee[] = {"keepassxc", NULL};
static const char *spt[] = {"spotify", NULL};
static const char *ql[] = {"quick-links", NULL};
static const char *bor [] = {"qutebrowser", NULL};
...
static const char *termcmdx[] = {"alacritty", NULL};
// volume controls
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_Return, spawn, {.v = termcmdx}},
    {MODKEY | ShiftMask, XK_w, spawn, {.v = yt}},
    {MODKEY,             XK_b, spawn, {.v = bor}},
    {MODKEY, XK_v, togglebar, {0}},
    {MODKEY | ShiftMask, XK_s, spawn, {.v = kee}},
    {MODKEY | ShiftMask, XK_e, spawn, {.v = ql}},
